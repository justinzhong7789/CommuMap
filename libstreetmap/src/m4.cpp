...
//        dropOffInd[trial] = dropOffInd[trial+3];
...
//            
//            int tempInter;
//            if(b.pickUp_indices.size()!=0){
//                a.end_intersection = deliveries[b.pickUp_indices[0]].pickUp; //4th pickup
//            }else(dropOffInd[trial+1].size() ! = 0){
//                a.end_intersection = deliveries[dropOffInd[trial+1][0]].dropOff;
//            }
//            
//            a.subpath = updatePathInfo(a.start_intersection, a.end_intersection, -1, turnPenalty);
//            
//            b.start_intersection = d.start_intersection;
//            b.subpath = updatePathInfo(b.start_intersection, b.end_intersection, -1, turnPenalty);
//            
//            tempInter = c.end_intersection;
//            c.end_intersection = c.start_intersection;
//            c.start_intersection = tempInter;
//            c.subpath = updatePathInfo(c.start_intersection, c.end_intersection,-1, turnPenalty);
//            
//            if(d.pickUp_indices.size()!=0){
//                d.start_intersection= deliveries[d.pickUp_indices[0]].pickUp; //4th pickup
//            }else(dropOffInd[trial+3].size() ! = 0){
//                d.start_intersection = deliveries[dropOffInd[trial+3][0]].dropOff;
//            }
//            
//            d.subpath = updatePathInfo(d.start_intersection, d.end_intersection, -1, turnPenalty);
//        }
//    }
//    else{
//        trial++;
