...
void draw_main_canvas(ezgl::renderer *g) {
    ...
    if (numTimesDrawn == 0) {
        ...
        //Numbers from full-screen x and y coordinates
//        full_map.m_first.x = -57.8158;
//        full_map.m_first.y = 43.4805;
//        
//        full_map.m_second.x = -56.9837;
//        full_map.m_second.y = 43.9191;
