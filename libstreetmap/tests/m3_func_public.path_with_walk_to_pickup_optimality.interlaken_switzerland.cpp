...
struct MapFixture {
    ...
    TEST(find_path_with_walk_to_pick_up_optimality) {
        ...
        CHECK(compute_path_travel_time(path.second, 22.58759087598575732) <= 124.58000532343083933);
        ...
        CHECK(compute_path_travel_time(path.second, 21.50123978084875986) <= 15.57533070062815028);
        ...
        CHECK(compute_path_travel_time(path.second, 23.24724699156175944) <= 4.61653438058649712);
        ...
        CHECK(compute_path_travel_time(path.second, 24.74049806129059093) <= 403.43542615482834890);
        ...
        CHECK(compute_path_travel_time(path.second, 17.38266612778162568) <= 303.63120635870063779);
        ...
        CHECK(compute_path_travel_time(path.second, 18.40129796266718643) <= 323.77342248912839295);
        ...
        CHECK(compute_path_travel_time(path.second, 24.80338191831117456) <= 316.98375656071902995);
        ...
        CHECK(compute_path_travel_time(path.second, 21.45775725742914375) <= 8.54134180338379956);
        ...
        CHECK(compute_path_travel_time(path.second, 22.04203310234851898) <= 572.54921763245033617);
        ...
        CHECK(compute_path_travel_time(path.second, 17.77525196070857660) <= 302.52278938640694150);
        ...
        CHECK(compute_path_travel_time(path.second, 17.46513984523502216) <= 352.36717014477977727);
        ...
        CHECK(compute_path_travel_time(path.second, 16.39187402126722048) <= 89.33305104789323536);
        ...
        CHECK(compute_path_travel_time(path.second, 15.72791721664213505) <= 166.09840244695456590);
        ...
        CHECK(compute_path_travel_time(path.second, 19.73220619629803707) <= 315.39864371184273750);
        ...
        CHECK(compute_path_travel_time(path.second, 20.58452655600576264) <= 332.25012290332813336);
        ...
        CHECK(compute_path_travel_time(path.second, 24.69242195727185418) <= 528.08043963229249584);
        ...
        CHECK(compute_path_travel_time(path.second, 18.12727336456592298) <= 187.41276930712351145);
        ...
        CHECK(compute_path_travel_time(path.second, 22.60801995389195795) <= 452.85774024694444506);
        ...
        CHECK(compute_path_travel_time(path.second, 15.01240003546097590) <= 505.06180344876105437);
        ...
        CHECK(compute_path_travel_time(path.second, 15.22913018357345294) <= 93.63026186432027487);
        ...
        CHECK(compute_path_travel_time(path.second, 19.76185147836938683) <= 447.23648095909862832);
        ...
        CHECK(compute_path_travel_time(path.second, 15.29998809213639177) <= 349.83248878105672475);
        ...
        CHECK(compute_path_travel_time(path.second, 19.66787855447711664) <= 5.07684371247021993);
        ...
        CHECK(compute_path_travel_time(path.second, 20.69849316530155647) <= 728.89103173484204490);
        ...
        CHECK(compute_path_travel_time(path.second, 22.93556533270106712) <= 265.10976713055435994);
        ...
        CHECK(compute_path_travel_time(path.second, 18.22304086160225722) <= 150.44670469827161696);
        ...
        CHECK(compute_path_travel_time(path.second, 23.14467005467510319) <= 231.11721300039485527);
        ...
        CHECK(compute_path_travel_time(path.second, 17.16173232004141624) <= 245.78584727508550145);
        ...
        CHECK(compute_path_travel_time(path.second, 23.46132436906174945) <= 17.18750928307949266);
        ...
        CHECK(compute_path_travel_time(path.second, 21.77376355368367200) <= 454.39498723772703670);
