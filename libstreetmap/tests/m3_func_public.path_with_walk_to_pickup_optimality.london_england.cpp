...
struct MapFixture {
    ...
    TEST(find_path_with_walk_to_pick_up_optimality) {
        ...
        CHECK(compute_path_travel_time(path.second, 20.56643390083450385) <= 1695.16891564703405493);
        ...
        CHECK(compute_path_travel_time(path.second, 23.24724699156175944) <= 9.01800882798833214);
        ...
        CHECK(compute_path_travel_time(path.second, 21.25477987116730105) <= 8.81569686872946257);
        ...
        CHECK(compute_path_travel_time(path.second, 18.50759507368418610) <= 3405.13718717348365317);
        ...
        CHECK(compute_path_travel_time(path.second, 24.92187560353409026) <= 2716.52449899589191773);
        ...
        CHECK(compute_path_travel_time(path.second, 20.11605397431454634) <= 2269.31555397192050805);
        ...
        CHECK(compute_path_travel_time(path.second, 22.38363928283910553) <= 1947.92364684411040798);
        ...
        CHECK(compute_path_travel_time(path.second, 17.54559835623686581) <= 27.73170006280188460);
        ...
        CHECK(compute_path_travel_time(path.second, 16.92280555852369517) <= 2571.30198119527449307);
        ...
        CHECK(compute_path_travel_time(path.second, 21.23306273583789050) <= 1670.06125065869514401);
        ...
        CHECK(compute_path_travel_time(path.second, 24.83484050724447911) <= 3125.33308108035680561);
        ...
        CHECK(compute_path_travel_time(path.second, 17.79158648691273470) <= 2825.39429032956968513);
        ...
        CHECK(compute_path_travel_time(path.second, 22.60549692457038518) <= 3122.74959625851988676);
        ...
        CHECK(compute_path_travel_time(path.second, 19.65814383955234490) <= 2084.33706943888546448);
        ...
        CHECK(compute_path_travel_time(path.second, 23.46132436906174945) <= 1.09075260347654202);
        ...
        CHECK(compute_path_travel_time(path.second, 21.44660135770386944) <= 3139.12513911991209170);
        ...
        CHECK(compute_path_travel_time(path.second, 20.52046685992282704) <= 3251.29216827755499253);
        ...
        CHECK(compute_path_travel_time(path.second, 24.44644791758729951) <= 4035.00915593749004984);
        ...
        CHECK(compute_path_travel_time(path.second, 23.29661237256773632) <= 947.40188843962448573);
        ...
        CHECK(compute_path_travel_time(path.second, 23.19714671248527083) <= 1401.46722405676268863);
        ...
        CHECK(compute_path_travel_time(path.second, 21.69284068351273831) <= 2632.41602374954527477);
        ...
        CHECK(compute_path_travel_time(path.second, 21.61594626068436753) <= 14.46226659459969710);
        ...
        CHECK(compute_path_travel_time(path.second, 17.00609809812324968) <= 3213.01596226062838468);
